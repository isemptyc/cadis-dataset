...
This document provides a structural, behavioral, and boundary-integrity evaluation of the `gb.admin v1.0.3` dataset under Cadis Runtime.
...
The engine uses canonical names from `name:en`, `name`, `name:ga`, and `official_name`, with bounded multilingual aliases for English, Welsh, Scottish Gaelic, and Irish.
...
* Dataset path: `GB/gb.admin/v1.0.3`
...
| Throughput | `11277.630` QPS |
| Total Runtime | `8.867 sec` |
...
No explicit repair layer is required for `gb.admin v1.0.3`.
...
A direct Belfast smoke lookup returned `Northern Ireland > Belfast City District`, with the level-4 Northern Ireland multilingual name set including Irish `ga`.
...
- cadis-dataset-engine commit:
  `87db6070f2a74c16bf196124a18c911ae52372e1`
- Cadis version:
  `0.8.159`
- Boundary builder: `scripts/build_gb_boundaries.py`
- Build boundary: `tmp/gb_country.json`
- Evaluation boundary: `tmp/gb_country.json`
- Staged dataset: `GB/gb.admin/v1.0.3`
